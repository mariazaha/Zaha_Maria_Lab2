...
options.UseSqlServer(builder.Configuration.GetConnectionString("Zaha_Maria_Lab2Context") ?? throw new InvalidOperationException("Connections tring 'Nume_Pren_Lab2Context' not found."))); 
